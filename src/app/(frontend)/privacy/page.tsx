...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <h2 className="text-2xl text-black font-serif font-bold mt-12 mb-6">Information Collection</h2>
      <p>
      ...
      <h2 className="text-2xl text-black font-serif font-bold mt-12 mb-6">Data Security</h2>
      <p>
      ...
      <h2 className="text-2xl text-black font-serif font-bold mt-12 mb-6">No Third-Party Sharing</h2>
      <p>
