...
export default function AboutPage() {
  return (
    ...
    >
      ...
      <h2 className="text-2xl text-un-text font-serif font-bold mt-12 mb-6">Intelligence, Not News</h2>
      <p>
      ...
      <h2 className="text-2xl text-un-text font-serif font-bold mt-12 mb-6">Our Editorial Philosophy</h2>
      <ul className="space-y-4 text-un-muted">
