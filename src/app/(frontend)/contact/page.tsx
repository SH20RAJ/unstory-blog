...
export default function ContactPage() {
  return (
    ...
    >
      <p className="text-center text-premium-muted mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
        <div className="premium-card p-8 text-center">
          ...
          <p className="text-black text-lg">tips@unstory.app</p>
        </div>
        <div className="premium-card p-8 text-center">
          <h3 className="text-brand font-bold uppercase tracking-widest text-xs mb-4">General</h3>
          <p className="text-black text-lg">hello@unstory.app</p>
        </div>
      </div>

      <div className="mt-16 pt-16 border-t border-premium-border text-center">
