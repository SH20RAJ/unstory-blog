...
export default function AdvertisePage() {
  return (
    ...
    >
      <p className="text-xl text-premium-muted font-serif italic mb-12 text-center">
        Reach a high-intent audience of founders, investors, and technologists.
      </p>
      
      <div className="space-y-12">
        <section>
          <h2 className="text-2xl text-black font-serif font-bold mb-6">Our Audience</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl text-black font-serif font-bold mb-6">Partnership Opportunities</h2>
        ...
        <div className="premium-card p-12 text-center bg-white border-brand/20">
          <h3 className="text-2xl font-serif text-black mb-6">Ready to collaborate?</h3>
          <p className="text-premium-muted mb-8">Download our media kit or request a consultation.</p>
