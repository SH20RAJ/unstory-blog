  ...
  return (
    <nav className={cn("flex items-center justify-center space-x-2", className)}>
      <Link
        ...
        className={cn(
          "p-2 rounded-md border border-un-border text-un-muted hover:text-un-text transition-colors",
        ...
        <Link
          ...
          className={cn(
            ...
            currentPage === page
              ...
              : "border-un-border text-un-muted hover:border-brand/50 hover:text-un-text"
          )}
        >
          {page}
        </Link>
