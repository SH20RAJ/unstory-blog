...
export function CategorySection({ title, slug, articles }: CategorySectionProps) {
  ...
  return (
    <section className="py-12 border-t border-premium-border first:border-t-0">
      <div className="flex items-end justify-between mb-10">
        ...
        <Link 
          href={`/category/${slug}`} 
          className="flex items-center space-x-1 text-sm font-semibold text-premium-muted hover:text-brand transition-colors group"
        >
